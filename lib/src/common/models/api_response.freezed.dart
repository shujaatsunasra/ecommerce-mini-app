...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<T> items, int total, int skip, int limit});
}
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(items: $items, total: $total, skip: $skip, limit: $limit)';
  }
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      ...
      required final int limit}) = _$ApiResponseImpl<T>;
